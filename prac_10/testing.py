...
def repeat_string(s, n):
    ...
    for i in range(n):
        repeated_string_list.append(s)
    return ' '.join(repeated_string_list)
...
def phrase_to_sentence(word):
    ...
    'It is an ex parrot.'
    >>> phrase_to_sentence("this is fun")
    'This is fun.'
    """
...
def run_tests():
    ...
    assert test_car.fuel == 0, 'Car is not at 0 fuel at initialisation'

    test_car = Car(fuel=10)
    assert test_car.fuel == 10, 'Car fuel has not been initialised at 10'
